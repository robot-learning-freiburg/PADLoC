...
if __name__ == '__main__':
    ...
    frame1.axis("off")
    plt.plot(poses[51:, 0, 3], poses[51:, 1, 3], 'lightgray')
    plt.scatter(poses[np.nonzero(fp)[0]+51, 0, 3], poses[np.nonzero(fp)[0]+51, 1, 3], c=[(228/255, 26/255, 28/255)], s=15)
    plt.scatter(poses[np.nonzero(fn)[0]+51, 0, 3], poses[np.nonzero(fn)[0]+51, 1, 3], c='b', s=15)
    plt.scatter(poses[np.nonzero(tp)[0]+51, 0, 3], poses[np.nonzero(tp)[0]+51, 1, 3], c=[(77./255, 175./255, 74./255)], s=15)
    # plt.show()
