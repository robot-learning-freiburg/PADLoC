...
def infer_and_plot(*, dataset, device, model, frames, style, image_paths, augment_positive=None, z_distance=120., **_):
    ...
    for i, image_path in enumerate(image_paths):
        ...
        plot_matches(anc_pc=samples["anchor"][i], anc_samp_ids=anc_samp_ids,
                     ...
                     anc_sem=samples["anchor_semantic"][i],
                     pos_sem=samples["positive_semantic"][i],
...
def main(kitti_path, seq, cp_path, frames, image_paths, gpu=0, style="bw", augment_positive=None, z_distance=120.):
    ...
    infer_and_plot(dataset=kitti_dataset, device=cuda_device, frames=frames, model=model,
                   style=style, image_paths=image_paths, augment_positive=augment_positive, z_distance=z_distance)
