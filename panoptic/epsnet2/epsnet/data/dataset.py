...
class ISSDataset(data.Dataset):
    ...
    def _load_item(self, item):
        ...
        track_id = img_desc["track_id"]
        return img, msk, cat, track_id, iscrowd, img_desc["id"]
    ...
    def __getitem__(self, item):
        img, msk, cat, track_id, iscrowd, idx = self._load_item(item)
        rec = self.transform(img, msk, cat, track_id, iscrowd)
