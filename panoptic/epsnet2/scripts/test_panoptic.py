...
parser.add_argument("--score_threshold", type=float, default=0.5, help="Detection confidence thr")
parser.add_argument("--iou_threshold", type=float, default=0.5, help="Panoptic disambiguation IoU thr")
