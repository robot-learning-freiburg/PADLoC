...
class ConfigSemanticKITTI2:
    ...
    sub_sampling_ratio = [2, 2, 2, 2]  # sampling ratio of random sampling at each layer
    d_out = [16, 64, 128, 256]  # feature dimension
    num_sub_points = [num_points // 2, num_points // 4, num_points // 8, num_points // 16]
