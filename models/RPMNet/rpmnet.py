...
from models.RPMNet.torch import to_numpy
from models.RPMNet.pointnet_util import square_distance, angle_difference
from models.RPMNet.feature_nets import FeatExtractionEarlyFusion
from models.RPMNet.feature_nets import ParameterPredictionNet
# from models.feature_nets import ParameterPredictionNetConstant as ParameterPredictionNet
from models.RPMNet import se3
...
class RPMNet(nn.Module):
    ...
    def forward(self, data, num_iter: int = 2):
...
class RPMNetEarlyFusion(RPMNet):
    ...
    def __init__(self, features=['ppf','dxyz','xyz'], feature_dim=96,
                 radius=0.3, num_neighbors=64):
        super().__init__()

        self.weights_net = ParameterPredictionNet(weights_dim=[0])
        self.feat_extractor = FeatExtractionEarlyFusion(
            features=features, feature_dim=feature_dim,
